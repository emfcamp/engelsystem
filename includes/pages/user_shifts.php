...
function view_user_shifts() {
  ...
  return page(array(
      ...
      template_render('../templates/user_shifts.html', array(
          'title' => shifts_title(),
          'room_select' => in_array('user_shifts_admin', $privileges) ? make_select($rooms, $_SESSION['user_shifts']['rooms'], "rooms", _("Rooms")) : '',
          ...
          'type_select' => in_array('user_shifts_admin', $privileges) ? make_select($types, $_SESSION['user_shifts']['types'], "types", _("Roles")) : '',
